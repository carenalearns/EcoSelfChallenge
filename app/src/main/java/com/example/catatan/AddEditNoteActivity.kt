...
class AddEditNoteActivity : AppCompatActivity() {
    companion object {
        const val EXTRA_ID = "com.example.catatan.EXTRA_ID"
        const val EXTRA_JUDUL = "com.example.catatan.EXTRA_JUDUL"
        const val EXTRA_DESKRIPSI = "com.example.catatan.EXTRA_DESKRIPSI"
        const val EXTRA_PRIORITAS = "com.example.catatan.PRIORITAS"
    }
